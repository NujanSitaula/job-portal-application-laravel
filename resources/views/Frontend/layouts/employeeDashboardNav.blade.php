            ...
            <div class="dashboard-nav">
                <div class="dashboard-inner">
                    <ul data-submenu-title="Main Navigation">
                        ...
                        <li><a href="{{ route('employee.resume.create') }}"><i class="lni lni-add-files mr-2"></i>Create Resume</a></li>
                        <li><a href="{{ route('employee.job.applied') }}"><i class="lni lni-briefcase mr-2"></i>Applied jobs</a></li>
                        <li><a href=""><i class="ti-bell mr-2"></i>Alert Jobs<span class="count-tag bg-warning">4</span></a></li>
                        <li><a href="{{ route('employee.job.bookmarks') }}"><i class="lni lni-bookmark mr-2"></i>Bookmark Jobs</a></li>
