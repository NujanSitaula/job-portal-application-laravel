            ...
            <div class="dashboard-nav">
                <div class="dashboard-inner">
                    <ul data-submenu-title="Main Navigation">
                        ...
                        <li class="{{ request()->is('about') ? 'active' : '' }}"><a href="dashboard-manage-applications.html"><i class="lni lni-briefcase mr-2"></i>Manage Applicants</a></li>
                        ...
                        <li class="{{ request()->is('about') ? 'active' : '' }}"><a href="dashboard-packages.html"><i class="lni lni-mastercard mr-2"></i>Packages</a></li>
                        <li class="{{ request()->is('about') ? 'active' : '' }}"><a href="dashboard-messages.html"><i class="lni lni-envelope mr-2"></i>Messages<span class="count-tag">4</span></a></li>
                    </ul>
