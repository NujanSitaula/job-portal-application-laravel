            ...
            <div class="dashboard-nav">
                <div class="dashboard-inner">
                    <ul data-submenu-title="Main Navigation">
                        ...
                        <li class="{{ request()->is('about') ? 'active' : '' }}"><a href="{{ route('manage.applications') }}"><i class="lni lni-briefcase mr-2"></i>Manage Applicants</a></li>
                        ...
                        <li class="{{ request()->is('about') ? 'active' : '' }}"><a href="{{ route('employer.employee.boost') }}"><i class="lni lni-mastercard mr-2"></i>Boost Jobs</a></li>
                        <li class="{{ request()->is('about') ? 'active' : '' }}"><a href="{{ route('chat') }}"><i class="lni lni-envelope mr-2"></i>Messages{{--<span class="count-tag">4</span> --}}</a></li> 
                    </ul>
