                                    ...
                                    <div class="cats-box-caption px-2">
                                        ...
                                        <div class="ico-content">
                                            <ul>
                                                ...
                                                <li><a wire:click='checkconversation({{ $application->employee->id }})' class="px-2 py-1 medium bg-light-info rounded text-info" style="border:none;"><i class="lni lni-envelope mr-1"></i>Message</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
