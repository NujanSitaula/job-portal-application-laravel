    ...
    <div class="col-8">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.post.create.submit') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                        <label for="blog-title">Enter Blog Title:</label>
                        <input class="form-control" name="title" type="text" id="blog-title" placeholder="Enter Blog Title">
                    </div>
            ...
            <div class="card-body">
                ...
                <p class="card-title-desc">Bootstrap-wysihtml5 is a javascript plugin that makes it easy to create simple, beautiful wysiwyg editors with the help of wysihtml5 and Twitter Bootstrap.</p>
                    ...
                    <div class="mb-4">
                        ...
                        <input class="form-control" name="slug" type="text" id="blog-slug" placeholder="Enter Blog Slug">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="form-control" name="tags" type="text" id="blog-tags" placeholder="Enter Tags">
                    </div>
                    <div class="mb-4">
