        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col">
                        <a href="{{ route('admin.job.location') }}" class="btn btn-primary float-right"><i class="far fa-eye mr-2"></i> View All Locations</a>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-12">
                        <form action="{{ route('admin.job.location.edit.submit', $jobLocationID->id) }}" method="post">
                            @csrf
                        <div class="form-group">
                            <label>Category Name</label>
                            <input class="form-control" value="{{ $jobLocationID->name }}" name="name" type="text" placeholder="Enter Category Name">
                        </div>
                          <div class="form-group">
