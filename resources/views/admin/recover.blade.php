                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="p-2">
                                ...
                                <form class="form-horizontal" method="post" action="{{ route('admin.recover.submit') }}">
                                    @csrf
                                    ...
                                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                      ...
                                      <div class="form-group row mb-0">
                                        <div class="col-12 text-right">
                                            <a href="{{ route('admin.login') }}" class="btn btn-primary w-md waves-effect waves-light">Back To Login</a>
                                        </div>
                                    </div>
                                    @else
                                    ...
                                    <div class="form-group row mb-0">
                                        <div class="col-12 text-right">
                                            <button class="btn btn-primary w-md waves-effect waves-light" type="submit">Send Link</button>
                                        </div>
                                    </div>
                                    @endif
                                </form>
