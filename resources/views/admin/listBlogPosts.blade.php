        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col">
                        <button class="btn btn-primary float-right" data-toggle="modal" data-target=".bs-add-category-modal-center"><i class="far fa-plus-square mr-2"></i> Create New Post</button>
                    </div>
                </div>
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $item->id }}</td>
                            <td>{{ $item->title }}</td>
                            <td>{{ htmlspecialchars(trim(strip_tags(Str::words($item->content,20)))) }}</td>
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('post', $item->slug) }}" class="btn btn-sm btn-outline-primary mr-2" title="Edit" data-toggle="tooltip"><i class="mdi mdi-eye-circle-outline"></i> View</a>
                                <a href="{{ route('admin.post.edit', $item->id) }}" class="btn btn-sm btn-outline-primary mr-2" title="Edit" data-toggle="tooltip"><i class="mdi mdi-circle-edit-outline"></i> Edit</a>
                                <a href="{{ route('admin.post.delete', $item->id) }}" class="btn btn-sm btn-outline-danger" title="Delete" data-toggle="tooltip"><i class="mdi mdi-delete-outline"></i> Delete</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
